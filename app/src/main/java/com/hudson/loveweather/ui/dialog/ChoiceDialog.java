...
public class ChoiceDialog extends AbsDialog<ChoiceParams> {
     ...
     */
    public ChoiceDialog(Context context, ChoiceParams params) {
        super(context, params);
    }


    @Override
    protected View initContentView(Context context, ViewGroup parent, final ChoiceParams params) {
        View root = LayoutInflater.from(context).inflate(R.layout.dialog_choice, parent, false);
