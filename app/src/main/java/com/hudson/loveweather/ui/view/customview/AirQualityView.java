...
/**
 * 由于控件本身具备显示文字的功能，因此直接继承自TextView!!! oh yeah
 * Created by Hudson on 2018/5/27.
 */

public class AirQualityView extends TextView {
    private Paint mPaint;
    private int mRadius;
    private static final int STROKE_WIDTH = 3;
    private int mAirColor = 0xFF05A731;
    ...
    private void init() {
        ...
        setGravity(Gravity.CENTER);//设置文本居中
...
//        canvas.drawArc(paddingLeft+STROKE_WIDTH/2, paddingTop+STROKE_WIDTH/2, paddingLeft + mRadius*2, paddingTop +mRadius*2,0f,360.0f,true,mPaint);
    ...
    private void updateGradient(){
        mLinearGradient = new LinearGradient(0,mRect.bottom,
                0, mRect.top, generateColorArray(),generateColorRangeArray(), Shader.TileMode.CLAMP);
        initDst();
        initSrc();
    ...
    public void refresh(int airColor,int curLevel){
        mAirColor = airColor;
